...
public class ThanhVienFragment extends Fragment {
    ...
    ThanhVien thanhVien;
    EditText edt_maTV,edt_hoten,edt_namsinh,edt_cccd;
    Dialog dialog;
    int getPosition;
    @Override
    ...
    protected void openDialog(final Context context,final int type) {
        ...
        edt_cccd = dialog.findViewById(R.id.edt_cccd);
        ...
        if (type != 0) {
            ...
            edt_cccd.setText(String.valueOf(thanhVien.getCCCD()));
        } else {
    ...
    public int validate(String hoTen,String namSinh,String cccd) {
        ...
        if (hoTen.length() != 0 && namSinh.length() != 0 && cccd.length() != 0) {
            ...
            thanhVien.setCCCD(Integer.parseInt(cccd));
            check = 1;
        } else {
            if (hoTen.length() == 0) {
            ...
            if (cccd.length() == 0) {
                edt_cccd.setError("Không được để trống trường này !");
            }
            check = -1;
        }
        return check;
