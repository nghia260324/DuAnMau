...
public class SachAdapter extends RecyclerView.Adapter<SachAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull SachAdapter.ViewHolder holder, int position) {
        ...
        holder.tv_namsb.setText("Năm xuất bản: " + sach.getNamSB());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView tv_maSach,tv_tenSach,tv_giaThue,tv_tenLoai,tv_namsb;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tv_namsb = itemView.findViewById(R.id.tv_namsb);
